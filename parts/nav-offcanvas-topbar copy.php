...
<div class="maxwell-main-nav" data-sticky-container style="z-index:1;">
    
    <div class="top-bar large-12 columns" id="top-bar-menu" data-sticky data-options="marginTop:0;" data-sticky-on="large">
        <div class="top-bar-left maxwell-mobile float-left">
            <ul class="menu">
                <li><a href="https://himaxwelldemo.com/"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/maxwell_logo.png"></a></li>
            </ul>
        </div>

...
<div id="mybar" class="maxwell-main-nav" style="z-index:1;">
    ...
    <div class="top-bar large-12 columns" id="top-bar-menu">
        ...
        <div class="top-bar-right ab-right float-right show-for-large maxwell-nav">
            <ul class="menu">
                <li class="ab-test ab-nav">Start your free 15 day trial</li>
                <li class="ab-test"><a href="/request-a-demo" class="button  btn-maxwell">Request Demo</a></li>
